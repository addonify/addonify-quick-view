							...
							if ( isset( $value['multiselect'] ) && $value['multiselect'] ) {
								...
								if ( is_array( $setting_value ) ) {
									...
									if ( is_array( $json_decode_setting_value ) ) {
										$settings_values[ $id ] = $json_decode_setting_value;
									} else {
	...
	function addonify_quick_view_get_settings_sections_fields() {
		...
		return apply_filters(
			...
			array(
				...
				'tabs'            => array(
					'general'           => array(
						'title'    => esc_html__( 'General Settings', 'addonify-quick-view' ),
					...
					'quick_view_button' => array(
						'title'    => esc_html__( 'Quick View Button', 'addonify-quick-view' ),
					...
					'quick_view_modal'  => array(
						'title'    => esc_html__( 'Quick View Modal', 'addonify-quick-view' ),
						'icon'     => '',
