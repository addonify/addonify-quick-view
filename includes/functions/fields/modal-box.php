    ...
    function addonify_quick_view_modal_box_content_settings_fields() {
        ...
        return array(
            ...
            'modal_product_title_font_size' => array(
                'label'         => __( 'Product title font size', 'addonify-quick-view' ),
            ...
            'modal_product_title_font_weight' => array(
                'label'         => __( 'Product title font weight', 'addonify-quick-view' ),
                'type'          => 'select',
                'choices'       => array(
            ...
            'modal_product_title_line_height' => array(
                'label'         => __( 'Product title line height', 'addonify-quick-view' ),
            ...
            'modal_product_price_font_size' => array(
                'label'         => __( 'Product price font size', 'addonify-quick-view' ),
            ...
            'modal_product_price_font_weight' => array(
                'label'         => __( 'Product price font weight', 'addonify-quick-view' ),
                'type'          => 'select',
                'choices'       => array(
                    '400' => __( 'Normal', 'addonify-quick-view' ),
                    '500' => __( 'Medium', 'addonify-quick-view' ),
            ...
            'modal_on_sale_badge_font_size' => array(
                'label'         => __( 'Sale badge font size', 'addonify-quick-view' ),
            ...
            'wc_gallery_trigger_icon_size' => array(
                'label'         => __( 'Gallery trigger icon size', 'addonify-quick-view' ),
            ...
            'wc_gallery_trigger_icon_border_radius' => array(
                'label'         => __( 'Gallery trigger icon border radius', 'addonify-quick-view' ),
    ...
    function addonify_quick_view_modal_box_styles_settings_fields() {
        ...
        return array(
            ...
            'modal_box_inputs_background_color' => array(
                'label'			  => __( 'Inputs fields background color', 'addonify-quick-view' ),
                'type'            => 'color',
                'isAlpha'         => true,
                'className'       => 'fullwidth',
                'dependent'       => array( 'enable_plugin_styles' ),
            ...
            'modal_box_inputs_text_color' => array(
                'label'			  => __( 'Inputs Inputs fields text color', 'addonify-quick-view' ),
                'type'            => 'color',
                'isAlpha'         => true,
                'className'       => 'fullwidth',
                'dependent'       => array( 'enable_plugin_styles' ),
            ),
            'modal_box_inputs_border_color' => array(
                'label'			  => __( 'Inputs fields border color', 'addonify-quick-view' ),
                'type'            => 'color',
                'isAlpha'         => true,
                'className'       => 'fullwidth',
                'dependent'       => array( 'enable_plugin_styles' ),
